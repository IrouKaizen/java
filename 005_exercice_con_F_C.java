...
//Programme de conversion pour passer des degrés Celsius en degrés Fahrenheit
    ...
    do{//tant que reponse = O
        ...
        do{//tant que reponse n'est pas O ou N
            ...
            switch(mode){
                case '1': 
                    convertit = ((9.0/5.0) * aConvertir) + 32.0;
                    //double value =  (double) ( (int) (convertit * Math.pow(10, 2) + .5)) / Math.pow(10, 2);
                    System.out.print(aConvertir + " °C correspond à : " + arrondi(convertit, 2) + " °F.");//+"la valeur est"+ value);
                break;
                
                case '2':
                    convertit = ((aConvertir - 32) * 5) / 9;
                    System.out.println(aConvertir + " °F correspond à : " + arrondi(convertit, 2) + " °C.");
            }
            //On invite l'utilisateur à recommencer ou à quitter
            do{
